...
flowchart LR
  ...
  subgraph S[Spigot/Paper 1.8.8]
    MT[Main Thread<br/>Tick loop (20 TPS)]
    NMS[NMS Layer<br/>Packets · Entities · Physics · Hooks]
    MT --> NMS
  end

  subgraph A[Async Pools]
    IO[Storage I/O]
